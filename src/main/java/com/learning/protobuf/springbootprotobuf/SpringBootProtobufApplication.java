...
import com.learning.protobuf.springbootprotobuf.CourseProtos.Student;
import com.learning.protobuf.springbootprotobuf.CourseProtos.Student.PhoneNumber;
import com.learning.protobuf.springbootprotobuf.CourseProtos.Student.PhoneType;
...
public class SpringBootProtobufApplication {
  ...
  private List<Student> createTestStudents() {
    ...
    Student student1 = createStudent(1, "John", "Doe",
        "john.doe@baeldung.com", Arrays.asList(phone1));

    PhoneNumber phone2 = createPhone("234567", PhoneType.LANDLINE);
    Student student2 = createStudent(2, "Richard", "Roe",
        "richard.roe@baeldung.com", Arrays.asList(phone2));

    PhoneNumber phone3_1 = createPhone("345678", PhoneType.MOBILE);
    PhoneNumber phone3_2 = createPhone("456789", PhoneType.LANDLINE);
    Student student3 = createStudent(3, "Jane", "Doe",
        "jane.doe@baeldung.com", Arrays.asList(phone3_1, phone3_2));

    return Arrays.asList(student1, student2, student3);
  }

  private Student createStudent(int id, String firstName, String lastName,
                                String email, List<PhoneNumber> phones) {
